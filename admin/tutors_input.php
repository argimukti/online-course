...
if(isset($_POST["simpan"])){
  ...
  if(empty($error)){
    ...
    if($id != ""){
      $sqli1 = "UPDATE tutors SET nama = '$nama', foto='$foto_name' , isi = '$isi', tgl_isi = now() WHERE id = '$id'"; 
    } else {

      $sqli1 = "INSERT INTO tutors(nama,foto,isi) VALUES('$nama', '$foto_name ', '$isi')";
    }
    $q1 = mysqli_query($conn, $sqli1);
    if($q1){
